...
function isVoiceClientControl(value) {
	...
	if (message.type === "voice.inbox-deliver" || message.type === "voice.inbox-read") return Array.isArray(message.entryIds) && message.entryIds.length > 0 && message.entryIds.length <= 20 && message.entryIds.every((id) => typeof id === "string" && id.length > 0 && id.length <= 128);
