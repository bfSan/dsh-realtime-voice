...
export declare const SUPERVISOR_TOOL_NAMES: readonly ["list_voice_projects", "list_voice_agents", "list_voice_tasks", "read_voice_task_result", "select_voice_task", "create_voice_task", "submit_voice_task", "cancel_voice_task", "list_voice_butlers", "switch_voice_butler", "remember_voice_scope", "note_voice_todo"];
