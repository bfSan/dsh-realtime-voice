window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		const VOICE_WEB_CLIENT_VERSION = "0.1.0-alpha.20";
...
`;
		...
		*/
		...
		//#endregion
		//#region \0dsh-voice-css:/private/tmp/dsh-voice-supervisor-20260921/src/client/voice.module.css.mjs
		const css = ".PUKxhW_callButton{color:#fff;background:var(--dsw-alias-button-info-fill,#3964fe);cursor:pointer;border:0;border-radius:999px;flex:none;order:100;place-items:center;width:34px;height:34px;padding:0;transition:color .12s,background .12s,transform .12s,box-shadow .12s;display:inline-grid;transform:translateY(-2px)}.PUKxhW_callButton:hover{background:var(--dsw-alias-button-info-hover,#2f55dc)}.PUKxhW_callButton:active{transform:translateY(-2px)scale(.94)}.PUKxhW_callButton:disabled{color:color-mix(in srgb, currentColor 48%, transparent);background:color-mix(in srgb, var(--dsw-alias-surface-secondary,#eef0f5) 90%, transparent);cursor:not-allowed;box-shadow:none}.PUKxhW_callButtonActive{color:var(--dsw-alias-button-danger-text,#fff);background:var(--dsw-alias-button-danger-fill,#e5484d);box-shadow:0 0 0 4px color-mix(in srgb, var(--dsw-alias-button-danger-fill,#e5484d) 18%, transparent)}.PUKxhW_icon{fill:none;stroke:currentColor;stroke-width:1.55px;stroke-linecap:round;stroke-linejoin:round;width:17px;height:17px}.PUKxhW_stopGlyph{background:currentColor;border-radius:2px;width:8px;height:8px}.PUKxhW_overlay{border:1px solid var(--dsw-alias-border-subtle);width:min(372px,100vw - 40px);max-height:min(620px,100vh - 24px);color:var(--dsw-alias-text-primary);background:color-mix(in srgb, var(--dsw-alias-surface-primary) 94%, transparent);backdrop-filter:blur(18px);will-change:left, top;border-radius:18px;flex-direction:column;padding:16px;display:flex;position:fixed;top:72px;right:20px;overflow:hidden;box-shadow:0 18px 56px #0000002e}.PUKxhW_overlayError{gap:14px;width:min(372px,100vw - 40px)}.PUKxhW_dragHandle,.PUKxhW_voiceOrb{touch-action:none;user-select:none;cursor:grab}.PUKxhW_dragging,.PUKxhW_dragging .PUKxhW_dragHandle{cursor:grabbing;transition:none!important}.PUKxhW_voiceOrb{border:1px solid color-mix(in srgb, var(--dsw-alias-brand-primary,#3964fe) 45%, transparent);background:color-mix(in srgb, var(--dsw-alias-surface-primary,#fff) 88%, transparent);width:76px;height:76px;box-shadow:0 14px 38px #00000038, 0 0 0 6px color-mix(in srgb, var(--dsw-alias-brand-primary,#3964fe) 10%, transparent);backdrop-filter:blur(18px);will-change:left, top;border-radius:50%;padding:0;position:fixed;bottom:20px;right:20px;overflow:hidden}.PUKxhW_voiceOrb[data-phase=speaking]{box-shadow:0 14px 38px #00000038, 0 0 0 8px color-mix(in srgb, var(--dsw-alias-brand-primary,#3964fe) 17%, transparent)}.PUKxhW_orbButton{border-radius:inherit;color:#fff;width:100%;height:100%;cursor:inherit;background:radial-gradient(circle at 35% 28%,#7390ff 0,#3964fe 44%,#2747c9 100%);border:0;place-content:center;gap:5px;padding:0;display:grid}.PUKxhW_orbWaves{justify-content:center;align-items:center;gap:3px;height:22px;display:flex}.PUKxhW_orbWaves i{opacity:.92;background:currentColor;border-radius:999px;width:3px;height:8px;animation:.85s ease-in-out infinite alternate PUKxhW_voice-wave;display:block}.PUKxhW_orbWaves i:nth-child(2),.PUKxhW_orbWaves i:nth-child(4){height:15px;animation-delay:-240ms}.PUKxhW_orbWaves i:nth-child(3){height:21px;animation-delay:-420ms}.PUKxhW_voiceOrb[data-phase=listening] .PUKxhW_orbWaves i,.PUKxhW_voiceOrb[data-phase=agent-working] .PUKxhW_orbWaves i{animation-duration:1.25s}.PUKxhW_orbTime{font-variant-numeric:tabular-nums;opacity:.86;font-size:10px}@keyframes PUKxhW_voice-wave{0%{opacity:.62;transform:scaleY(.55)}to{opacity:1;transform:scaleY(1.15)}}.PUKxhW_overlayHeader,.PUKxhW_controls{justify-content:space-between;align-items:center;gap:10px;display:flex}.PUKxhW_overlayHeader{border-radius:12px;margin:-8px -8px 0;padding:8px}.PUKxhW_headerActions{align-items:center;gap:8px;display:flex}.PUKxhW_iconButton{border:1px solid var(--dsw-alias-border-l2,var(--dsw-alias-border-subtle));width:28px;height:28px;color:var(--dsw-alias-label-secondary,var(--dsw-alias-text-secondary));background:var(--dsw-alias-bg-layer-3,var(--dsw-alias-surface-primary));cursor:pointer;border-radius:999px;font-size:20px;line-height:1}.PUKxhW_eyebrow{color:var(--dsw-alias-text-secondary);margin-bottom:4px;font-size:12px;font-weight:600}.PUKxhW_phaseLine{align-items:center;gap:7px;font-size:15px;font-weight:600;display:flex}.PUKxhW_liveDot{background:var(--dsw-alias-status-success,#30a46c);width:8px;height:8px;box-shadow:0 0 0 5px color-mix(in srgb, var(--dsw-alias-status-success,#30a46c) 18%, transparent);border-radius:50%}.PUKxhW_agentState{color:var(--dsw-alias-text-secondary);background:var(--dsw-alias-fill-subtle);border-radius:999px;padding:6px 10px;font-size:12px}.PUKxhW_bindingCard{border:1px solid var(--dsw-alias-border-l2,var(--dsw-alias-border-subtle));background:var(--dsw-alias-bg-layer-3,var(--dsw-alias-fill-subtle));border-radius:12px;margin-top:14px;padding:12px}.PUKxhW_bindingLabel,.PUKxhW_speakerLabel{color:var(--dsw-alias-label-tertiary,var(--dsw-alias-text-secondary));font-size:11px;font-weight:600}.PUKxhW_bindingTitle{color:var(--dsw-alias-label-primary,var(--dsw-alias-text-primary));text-overflow:ellipsis;white-space:nowrap;margin-top:3px;font-size:14px;font-weight:600;overflow:hidden}.PUKxhW_bindingMeta{color:var(--dsw-alias-label-tertiary,var(--dsw-alias-text-secondary));margin-top:5px;font-size:11px;line-height:1.45}.PUKxhW_returnLink{color:var(--dsw-alias-brand-primary,#3964fe);cursor:pointer;background:0 0;border:0;margin-top:8px;padding:0;font-size:12px}.PUKxhW_transcripts{align-content:start;gap:12px;min-height:120px;max-height:230px;margin:14px 0;padding:2px 4px 2px 2px;display:grid;overflow-y:auto}.PUKxhW_transcriptBlock{background:var(--dsw-alias-fill-subtle,var(--dsw-alias-bg-layer-3));border-radius:12px;gap:4px;padding:10px 12px;display:grid}.PUKxhW_userText,.PUKxhW_assistantText{margin:0;line-height:1.5}.PUKxhW_userText{color:var(--dsw-alias-text-secondary);font-size:13px}.PUKxhW_assistantText{font-size:15px}.PUKxhW_agentSummary{border-left:3px solid var(--dsw-alias-brand-primary,#3964fe);max-height:120px;color:var(--dsw-alias-label-secondary,var(--dsw-alias-text-secondary));background:var(--dsw-alias-bg-layer-2,var(--dsw-alias-fill-subtle));border-radius:0 10px 10px 0;gap:5px;margin-bottom:12px;padding:10px 12px;font-size:12px;line-height:1.5;display:grid;overflow-y:auto}.PUKxhW_interactionCard{border:1px solid color-mix(in srgb, var(--dsw-alias-status-warning,#f2a20c) 55%, var(--dsw-alias-border-subtle));background:color-mix(in srgb, var(--dsw-alias-status-warning,#f2a20c) 8%, var(--dsw-alias-surface-primary));border-radius:12px;gap:8px;max-height:230px;margin-bottom:12px;padding:11px 12px;font-size:12px;display:grid;overflow-y:auto}.PUKxhW_interactionTitle{font-size:13px;font-weight:600}.PUKxhW_interactionDetail{color:var(--dsw-alias-label-secondary,var(--dsw-alias-text-secondary));margin:0;line-height:1.45}.PUKxhW_interactionActions{justify-content:flex-end;gap:8px;display:flex}.PUKxhW_allowButton,.PUKxhW_rejectButton{font:inherit;cursor:pointer;border:1px solid #0000;border-radius:999px;padding:6px 11px}.PUKxhW_allowButton{color:#fff;background:var(--dsw-alias-button-info-fill,#3964fe)}.PUKxhW_rejectButton{color:var(--dsw-alias-text-primary);border-color:var(--dsw-alias-border-subtle);background:var(--dsw-alias-surface-primary)}.PUKxhW_questionBlock{border-top:1px solid var(--dsw-alias-border-subtle);gap:6px;padding-top:7px;display:grid}.PUKxhW_questionOption{cursor:pointer;align-items:flex-start;gap:7px;line-height:1.4;display:flex}.PUKxhW_questionCustom{border:1px solid var(--dsw-alias-border-subtle);min-width:0;height:32px;color:var(--dsw-alias-text-primary);background:var(--dsw-alias-surface-primary);font:inherit;border-radius:8px;padding:0 9px}.PUKxhW_controls{border-top:1px solid var(--dsw-alias-border-l2,var(--dsw-alias-border-subtle));flex-wrap:wrap;justify-content:flex-end;margin-top:auto;padding-top:12px}.PUKxhW_secondaryButton,.PUKxhW_endButton{border:1px solid var(--dsw-alias-border-subtle);color:var(--dsw-alias-text-primary);background:var(--dsw-alias-surface-primary);cursor:pointer;border-radius:999px;padding:7px 12px}.PUKxhW_endButton{color:#fff;background:var(--dsw-alias-button-danger-fill,#e5484d);border-color:#0000}.PUKxhW_inlineError,.PUKxhW_errorText{color:var(--dsw-alias-status-danger-text,#d13438);font-size:13px}.PUKxhW_errorText{flex:1}.PUKxhW_settingsCard{border:1px solid var(--dsw-alias-border-l2,var(--dsw-alias-border-subtle));color:var(--dsw-alias-label-primary,var(--dsw-alias-text-primary));background:var(--dsw-alias-bg-layer-3,var(--dsw-alias-surface-primary));border-radius:12px;list-style:none}.PUKxhW_settingsCardHeader{align-items:center;gap:12px;padding:14px 16px;display:flex}.PUKxhW_settingsCardIcon{color:#fff;background:var(--dsw-alias-button-info-fill,#3964fe);border-radius:10px;flex:none;place-items:center;width:34px;height:34px;display:grid}.PUKxhW_settingsCardHeading{gap:3px;min-width:0;display:grid}.PUKxhW_settingsCardHeading strong{font-size:15px}.PUKxhW_settingsCardHeading span{color:var(--dsw-alias-label-tertiary,var(--dsw-alias-text-secondary));font-size:13px;line-height:1.45}.PUKxhW_settingsCardBody{border-top:1px solid var(--dsw-alias-border-l2,var(--dsw-alias-border-subtle));margin:0 16px;padding:14px 0 16px}.PUKxhW_settingsLabel{margin-bottom:9px;font-size:13px;font-weight:600}.PUKxhW_modelSwitch{grid-template-columns:repeat(2,minmax(0,1fr));gap:10px;display:grid}.PUKxhW_modelSwitchThree{grid-template-columns:repeat(3,minmax(0,1fr));gap:10px;display:grid}.PUKxhW_modelChoice{border:1px solid var(--dsw-alias-border-l2,var(--dsw-alias-border-subtle));min-width:0;color:inherit;background:var(--dsw-alias-bg-layer-2,transparent);text-align:left;cursor:pointer;border-radius:10px;padding:11px 34px 11px 12px;position:relative}.PUKxhW_modelChoiceSelected{border-color:var(--dsw-alias-brand-primary,#3964fe);box-shadow:0 0 0 1px var(--dsw-alias-brand-primary,#3964fe)}.PUKxhW_modelChoice:disabled{opacity:.55;cursor:default}.PUKxhW_modelChoiceTitle,.PUKxhW_modelChoiceDetail{display:block}.PUKxhW_modelChoiceTitle{font-size:14px;font-weight:600}.PUKxhW_modelChoiceDetail{color:var(--dsw-alias-label-tertiary,var(--dsw-alias-text-secondary));margin-top:4px;font-size:11px;line-height:1.4}.PUKxhW_radioDot{border:1px solid var(--dsw-alias-label-dimmed,#8a8f98);border-radius:50%;width:12px;height:12px;position:absolute;top:13px;right:12px}.PUKxhW_modelChoiceSelected .PUKxhW_radioDot{border:4px solid var(--dsw-alias-brand-primary,#3964fe)}.PUKxhW_settingsHint,.PUKxhW_settingsError{color:var(--dsw-alias-label-tertiary,var(--dsw-alias-text-secondary));margin:9px 0 0;font-size:12px;line-height:1.5}.PUKxhW_settingsSubsection{border-top:1px solid var(--dsw-alias-border-l2,var(--dsw-alias-border-subtle));margin-top:14px;padding-top:14px}.PUKxhW_settingsError{color:var(--dsw-alias-label-error,#d13438)}.PUKxhW_numberRow{gap:12px;margin-top:12px;display:flex}.PUKxhW_numberField{flex:1;gap:6px;min-width:0;display:grid}.PUKxhW_numberFieldLabel{color:var(--dsw-alias-label-tertiary,var(--dsw-alias-text-secondary));font-size:12px}.PUKxhW_numberFieldInput{border:1px solid var(--dsw-alias-border-l2,var(--dsw-alias-border-subtle));background:var(--dsw-alias-bg-layer-2,var(--dsw-alias-surface-primary));border-radius:8px;align-items:center;gap:6px;height:34px;padding:0 10px;display:flex}.PUKxhW_numberInput{width:100%;min-width:0;color:var(--dsw-alias-label-primary,var(--dsw-alias-text-primary));font:inherit;background:0 0;border:0;outline:none;font-size:13px}.PUKxhW_numberSuffix{color:var(--dsw-alias-label-tertiary,var(--dsw-alias-text-secondary));flex:none;font-size:12px}.PUKxhW_numberFieldInput:has(.PUKxhW_numberInput:disabled){opacity:.5}.PUKxhW_selectField{gap:6px;display:grid}.PUKxhW_selectInput{border:1px solid var(--dsw-alias-border-l2,var(--dsw-alias-border-subtle));height:34px;color:var(--dsw-alias-label-primary,var(--dsw-alias-text-primary));background:var(--dsw-alias-bg-layer-2,var(--dsw-alias-surface-primary));font:inherit;border-radius:8px;padding:0 10px;font-size:13px}.PUKxhW_voicePreviewRow{align-items:center;gap:8px;display:flex}.PUKxhW_voicePreviewRow .PUKxhW_selectInput{flex:1;min-width:0}.PUKxhW_previewButton{border:1px solid var(--dsw-alias-border-l2,var(--dsw-alias-border-subtle));min-width:68px;height:34px;color:var(--dsw-alias-brand-primary,#3964fe);background:var(--dsw-alias-bg-layer-2,var(--dsw-alias-surface-primary));font:inherit;cursor:pointer;border-radius:8px;flex:none;padding:0 12px;font-size:13px}.PUKxhW_previewButton:disabled{opacity:.5;cursor:default}.PUKxhW_selectInput:disabled{opacity:.5}.PUKxhW_toggleRow{align-items:center;gap:8px;height:34px;display:flex}.PUKxhW_toggle{background:var(--dsw-alias-border-l2,#d5d8de);cursor:pointer;border:0;border-radius:11px;flex:none;width:40px;height:22px;padding:0;transition:background .15s;position:relative}.PUKxhW_toggle:disabled{opacity:.5;cursor:default}.PUKxhW_toggleOn{background:var(--dsw-alias-button-info-fill,#3964fe)}.PUKxhW_toggleKnob{background:#fff;border-radius:50%;width:18px;height:18px;transition:transform .15s;position:absolute;top:2px;left:2px}.PUKxhW_toggleOn .PUKxhW_toggleKnob{transform:translate(18px)}.PUKxhW_toggleCaption{color:var(--dsw-alias-label-tertiary,var(--dsw-alias-text-secondary));font-size:12px}.PUKxhW_styleField{gap:6px;margin-top:12px;display:grid}.PUKxhW_styleInput{border:1px solid var(--dsw-alias-border-l2,var(--dsw-alias-border-subtle));resize:vertical;width:100%;color:var(--dsw-alias-label-primary,var(--dsw-alias-text-primary));background:var(--dsw-alias-bg-layer-2,var(--dsw-alias-surface-primary));font:inherit;border-radius:8px;outline:none;padding:9px 10px;font-size:13px;line-height:1.5}.PUKxhW_styleInput:focus{border-color:var(--dsw-alias-brand-primary,#3964fe)}.PUKxhW_styleInput:disabled{opacity:.5}.PUKxhW_credentialSection{border-top:1px solid var(--dsw-alias-border-l2,var(--dsw-alias-border-subtle));margin-top:14px;padding-top:14px}.PUKxhW_credentialStatus{color:var(--dsw-alias-label-tertiary,var(--dsw-alias-text-secondary));align-items:center;gap:7px;margin-bottom:9px;font-size:12px;display:flex}.PUKxhW_credentialDot{background:var(--dsw-alias-label-error,#d13438);border-radius:50%;flex:none;width:7px;height:7px}.PUKxhW_credentialStatus[data-configured] .PUKxhW_credentialDot{background:var(--dsw-alias-status-success,#30a46c);box-shadow:0 0 0 3px color-mix(in srgb, var(--dsw-alias-status-success,#30a46c) 14%, transparent)}.PUKxhW_credentialInputRow{gap:8px;display:flex}.PUKxhW_credentialInput{border:1px solid var(--dsw-alias-border-l2,var(--dsw-alias-border-subtle));min-width:0;height:36px;color:var(--dsw-alias-label-primary,var(--dsw-alias-text-primary));background:var(--dsw-alias-bg-layer-2,var(--dsw-alias-surface-primary));font:inherit;border-radius:8px;outline:none;flex:1;padding:0 11px;font-size:13px}.PUKxhW_credentialInput:focus{border-color:var(--dsw-alias-brand-primary,#3964fe)}.PUKxhW_credentialSave{color:#fff;background:var(--dsw-alias-button-info-fill,#3964fe);height:36px;font:inherit;cursor:pointer;border:0;border-radius:8px;flex:none;padding:0 13px;font-size:13px}.PUKxhW_credentialSave:disabled,.PUKxhW_credentialInput:disabled{opacity:.5;cursor:default}.PUKxhW_overlayIncoming{border-color:color-mix(in srgb, var(--dsw-alias-brand-primary,#3964fe) 42%, transparent);gap:10px;box-shadow:0 18px 42px #0f172a38}.PUKxhW_incomingHeader{cursor:grab;justify-content:space-between;align-items:flex-start;gap:10px;display:flex}.PUKxhW_ringDot{background:var(--dsw-alias-button-info-fill,#3964fe);border-radius:999px;width:8px;height:8px;animation:1.4s ease-out infinite PUKxhW_ringPulse;box-shadow:0 0 #3964fe8c}@keyframes PUKxhW_ringPulse{0%{box-shadow:0 0 #3964fe8c}70%{box-shadow:0 0 0 9px #3964fe00}to{box-shadow:0 0 #3964fe00}}.PUKxhW_incomingList{flex-direction:column;gap:6px;max-height:260px;margin:0;padding:0;list-style:none;display:flex;overflow-y:auto}.PUKxhW_incomingRow{border:1px solid var(--dsw-alias-border-secondary,#0f172a1a);background:var(--dsw-alias-bg-secondary,#0f172a05);border-radius:10px;flex-direction:column;gap:4px;padding:8px 10px;display:flex}.PUKxhW_incomingLabel{grid-template-columns:18px minmax(0,1fr);align-items:center;gap:8px;min-width:0;display:grid}.PUKxhW_rowCheck{border:1px solid var(--dsw-alias-border-secondary,#0f172a40);background:var(--dsw-alias-bg-primary,#fff);color:#fff;cursor:pointer;border-radius:5px;flex:none;place-items:center;width:18px;min-width:18px;max-width:18px;height:18px;padding:0;font-size:11px;line-height:1;display:grid}.PUKxhW_rowCheckOn{border-color:var(--dsw-alias-button-info-fill,#3964fe);background:var(--dsw-alias-button-info-fill,#3964fe)}.PUKxhW_rowCheck:focus-visible{outline:2px solid var(--dsw-alias-brand-primary,#3964fe);outline-offset:1px}.PUKxhW_rowAnswer{background:var(--dsw-alias-button-info-fill,#3964fe);color:#fff;font:inherit;cursor:pointer;border:0;border-radius:999px;flex:none;padding:2px 10px;font-size:11px}.PUKxhW_rowAction{border:1px solid var(--dsw-alias-border-secondary,#0f172a29);color:var(--dsw-alias-text-secondary,#475569);font:inherit;cursor:pointer;background:0 0;border-radius:999px;flex:none;padding:2px 8px;font-size:11px}.PUKxhW_incomingTitle{min-width:0;color:var(--dsw-alias-text-primary,#0f172a);text-overflow:ellipsis;white-space:nowrap;font-size:13px;font-weight:600;overflow:hidden}.PUKxhW_incomingMeta{color:var(--dsw-alias-text-tertiary,#64748b);text-overflow:ellipsis;white-space:nowrap;align-items:center;gap:6px;font-size:12px;display:flex;overflow:hidden}.PUKxhW_incomingStatus{color:var(--dsw-alias-brand-primary,#3964fe);background:#3964fe1f;border-radius:999px;flex:none;padding:1px 6px;font-size:11px}.PUKxhW_incomingStatus[data-status=failed]{color:#dc2626;background:#dc26261f}.PUKxhW_incomingStatus[data-status=cancelled]{color:#64748b;background:#64748b29}.PUKxhW_incomingActions{color:var(--dsw-alias-text-tertiary,#94a3b8);flex-wrap:wrap;align-items:center;gap:6px;font-size:11px;display:flex}.PUKxhW_incomingTime{text-overflow:ellipsis;white-space:nowrap;flex:1;min-width:0;overflow:hidden}.PUKxhW_linkButton{color:var(--dsw-alias-brand-primary,#3964fe);font:inherit;cursor:pointer;background:0 0;border:0;flex:none;padding:0;font-size:11px}.PUKxhW_incomingFooter{flex-wrap:wrap;align-items:center;gap:8px;display:flex}.PUKxhW_answerButton{color:#fff;background:var(--dsw-alias-button-info-fill,#3964fe);min-width:96px;height:34px;font:inherit;cursor:pointer;border:0;border-radius:999px;flex:1;font-size:13px}.PUKxhW_answerButton:disabled{opacity:.5;cursor:default}.PUKxhW_incomingHint{color:var(--dsw-alias-text-tertiary,#94a3b8);flex-basis:100%;font-size:11px}.PUKxhW_incomingNotice{color:var(--dsw-alias-text-secondary,#475569);background:#3964fe14;border-radius:8px;padding:6px 10px;font-size:12px}@media (width<=1199px){.PUKxhW_overlay{border-radius:16px;width:min(420px,100vw - 24px);max-height:min(560px,100vh - 24px);padding:14px;top:auto;bottom:12px;right:12px}.PUKxhW_voiceOrb{bottom:12px;right:12px}.PUKxhW_controls{justify-content:stretch}.PUKxhW_secondaryButton,.PUKxhW_endButton{flex:1}}@media (width<=520px){.PUKxhW_modelSwitch,.PUKxhW_modelSwitchThree{grid-template-columns:1fr}.PUKxhW_numberRow{flex-direction:column;gap:10px}}.PUKxhW_readConfirmation{border:1px solid;border-radius:8px;margin:8px 0;padding:12px}.PUKxhW_readConfirmation p{margin:0 0 8px}.PUKxhW_readConfirmation button+button{margin-left:8px}.PUKxhW_launcher{z-index:1000;color:var(--dsw-alias-text-primary,#e8e8ed);font-size:13px;position:fixed;bottom:20px;right:20px}.PUKxhW_launcherMenu{background:var(--dsw-alias-surface-primary,#22232a);border:1px solid #737580;border-radius:12px;width:min(360px,100vw - 40px);max-height:calc(100vh - 100px);padding:16px;position:absolute;bottom:44px;right:0;overflow:auto;box-shadow:0 8px 32px #0005}.PUKxhW_launcherMenu label{gap:6px;margin:12px 0;display:grid}.PUKxhW_launcherMenu select,.PUKxhW_launcherMenu input{box-sizing:border-box;width:100%;min-width:0}.PUKxhW_launcherTasks{gap:6px;max-height:180px;display:grid;overflow:auto}.PUKxhW_launcherTasks button{text-align:left;overflow-wrap:anywhere}";
		...
		var voice_module_css_default = {
			"settingsCardHeader": "PUKxhW_settingsCardHeader",
			"agentState": "PUKxhW_agentState",
			"selectField": "PUKxhW_selectField",
			"inlineError": "PUKxhW_inlineError",
			"assistantText": "PUKxhW_assistantText",
			"modelChoiceTitle": "PUKxhW_modelChoiceTitle",
			"bindingCard": "PUKxhW_bindingCard",
			"bindingMeta": "PUKxhW_bindingMeta",
			"secondaryButton": "PUKxhW_secondaryButton",
			"allowButton": "PUKxhW_allowButton",
			"settingsCardBody": "PUKxhW_settingsCardBody",
			"modelSwitch": "PUKxhW_modelSwitch",
			"numberField": "PUKxhW_numberField",
			"settingsCard": "PUKxhW_settingsCard",
			"numberFieldInput": "PUKxhW_numberFieldInput",
			"voicePreviewRow": "PUKxhW_voicePreviewRow",
			"errorText": "PUKxhW_errorText",
			"answerButton": "PUKxhW_answerButton",
			"incomingList": "PUKxhW_incomingList",
			"interactionTitle": "PUKxhW_interactionTitle",
			"dragHandle": "PUKxhW_dragHandle",
			"numberInput": "PUKxhW_numberInput",
			"overlayIncoming": "PUKxhW_overlayIncoming",
			"credentialSave": "PUKxhW_credentialSave",
			"ringDot": "PUKxhW_ringDot",
			"settingsSubsection": "PUKxhW_settingsSubsection",
			"questionCustom": "PUKxhW_questionCustom",
			"endButton": "PUKxhW_endButton",
			"transcripts": "PUKxhW_transcripts",
			"phaseLine": "PUKxhW_phaseLine",
			"modelSwitchThree": "PUKxhW_modelSwitchThree",
			"numberFieldLabel": "PUKxhW_numberFieldLabel",
			"styleInput": "PUKxhW_styleInput",
			"bindingTitle": "PUKxhW_bindingTitle",
			"credentialDot": "PUKxhW_credentialDot",
			"incomingHeader": "PUKxhW_incomingHeader",
			"voiceOrb": "PUKxhW_voiceOrb",
			"transcriptBlock": "PUKxhW_transcriptBlock",
			"modelChoice": "PUKxhW_modelChoice",
			"settingsHint": "PUKxhW_settingsHint",
			"controls": "PUKxhW_controls",
			"interactionCard": "PUKxhW_interactionCard",
			"selectInput": "PUKxhW_selectInput",
			"toggleOn": "PUKxhW_toggleOn",
			"launcherTasks": "PUKxhW_launcherTasks",
			"rowCheckOn": "PUKxhW_rowCheckOn",
			"launcherMenu": "PUKxhW_launcherMenu",
			"styleField": "PUKxhW_styleField",
			"credentialSection": "PUKxhW_credentialSection",
			"settingsCardHeading": "PUKxhW_settingsCardHeading",
			"orbButton": "PUKxhW_orbButton",
			"incomingRow": "PUKxhW_incomingRow",
			"incomingLabel": "PUKxhW_incomingLabel",
			"settingsLabel": "PUKxhW_settingsLabel",
			"ringPulse": "PUKxhW_ringPulse",
			"incomingTitle": "PUKxhW_incomingTitle",
			"settingsError": "PUKxhW_settingsError",
			"stopGlyph": "PUKxhW_stopGlyph",
			"incomingStatus": "PUKxhW_incomingStatus",
			"linkButton": "PUKxhW_linkButton",
			"incomingNotice": "PUKxhW_incomingNotice",
			"incomingMeta": "PUKxhW_incomingMeta",
			"callButtonActive": "PUKxhW_callButtonActive",
			"overlayError": "PUKxhW_overlayError",
			"dragging": "PUKxhW_dragging",
			"orbTime": "PUKxhW_orbTime",
			"eyebrow": "PUKxhW_eyebrow",
			"liveDot": "PUKxhW_liveDot",
			"agentSummary": "PUKxhW_agentSummary",
			"interactionDetail": "PUKxhW_interactionDetail",
			"settingsCardIcon": "PUKxhW_settingsCardIcon",
			"headerActions": "PUKxhW_headerActions",
			"numberRow": "PUKxhW_numberRow",
			"icon": "PUKxhW_icon",
			"numberSuffix": "PUKxhW_numberSuffix",
			"orbWaves": "PUKxhW_orbWaves",
			"credentialInputRow": "PUKxhW_credentialInputRow",
			"credentialInput": "PUKxhW_credentialInput",
			"incomingActions": "PUKxhW_incomingActions",
			"incomingHint": "PUKxhW_incomingHint",
			"iconButton": "PUKxhW_iconButton",
			"returnLink": "PUKxhW_returnLink",
			"bindingLabel": "PUKxhW_bindingLabel",
			"userText": "PUKxhW_userText",
			"rowAction": "PUKxhW_rowAction",
			"questionBlock": "PUKxhW_questionBlock",
			"voice-wave": "PUKxhW_voice-wave",
			"toggle": "PUKxhW_toggle",
			"modelChoiceSelected": "PUKxhW_modelChoiceSelected",
			"questionOption": "PUKxhW_questionOption",
			"toggleKnob": "PUKxhW_toggleKnob",
			"overlayHeader": "PUKxhW_overlayHeader",
			"toggleCaption": "PUKxhW_toggleCaption",
			"credentialStatus": "PUKxhW_credentialStatus",
			"incomingTime": "PUKxhW_incomingTime",
			"launcher": "PUKxhW_launcher",
			"modelChoiceDetail": "PUKxhW_modelChoiceDetail",
			"rowCheck": "PUKxhW_rowCheck",
			"toggleRow": "PUKxhW_toggleRow",
			"overlay": "PUKxhW_overlay",
			"rowAnswer": "PUKxhW_rowAnswer",
			"interactionActions": "PUKxhW_interactionActions",
			"previewButton": "PUKxhW_previewButton",
			"incomingFooter": "PUKxhW_incomingFooter",
			"readConfirmation": "PUKxhW_readConfirmation",
			"callButton": "PUKxhW_callButton",
			"speakerLabel": "PUKxhW_speakerLabel",
			"rejectButton": "PUKxhW_rejectButton",
			"radioDot": "PUKxhW_radioDot"
		};
		//#endregion
		...
		*/
		...
		function VoiceLauncher({ useVoice, startSupervisor, selectTask, createTask }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("aside", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
					...
					"aria-label": "电话与执行对象",
					children: [
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("strong", { children: "独立语音总管" }),
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", { children: "先通话，再选择已有任务或指定项目和 Agent 创建任务。" }),
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
							type: "button",
							className: voice_module_css_default.answerButton,
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
							role: "status",
							children: pendingTask ? "正在选择任务…" : connected ? `当前对象：${directory?.tasks.find((task) => task.taskId === voice.sessionId)?.title ?? (voice.sessionId === "voice-supervisor" ? "尚未选择" : voice.sessionId)}` : `电话状态：${voice.phase}`
						}),
