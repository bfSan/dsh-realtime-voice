window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		const VOICE_WEB_CLIENT_VERSION = "0.1.0-alpha.14";
...
`;
		...
		function VoiceSettingsCard({ useVoiceModelSettings, selectModel, selectTurnDetection, selectVoice, setVadThreshold, setSilenceDuration, setMaxHistoryTurns, setSpeechEmotion, setStylePrompt, selectProgressReporting, setProgressMinInterval, setProgressQuietTask, saveApiKey }) {
