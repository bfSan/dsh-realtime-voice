import { INPUT_SAMPLE_RATE, OUTPUT_FRAME_BYTES, OUTPUT_SAMPLE_RATE, VOICE_DIRECT_PROTOCOL, VOICE_INBOX_ROUTE, VOICE_PROTOCOL, VOICE_ROUTE, VOICE_STATUS_ROUTE, decodeAudioFrame, encodeAudioFrame, isVoiceClientControl } from "./protocol.js";
	...
	async execute(name, json) {
		...
		switch (name) {
			...
			case "create_voice_task": {
				if (!this.turn || isOralReport(this.turn.text)) return {
